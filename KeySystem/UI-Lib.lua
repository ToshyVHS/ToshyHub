...
function Module.Main(tabela)
    ...
    if loadstring(game:HttpGet("https://raw.githubusercontent.com/KrypDeveloper/Quasar/main/src/Settings/Keyless.lua"))() and tabela.Service == "toshyware" then
...
local function GetKey()
        ...
        TextBox.Text = loadstring(game:HttpGet('https://raw.githubusercontent.com/Panda-Repositories/PandaKS_Libraries/main/library/LuaLib/ROBLOX/PandaBetaLib.lua'))():GetKey(tabela.Service)
...
TextButton_2.MouseButton1Click:Connect(function()
  ...
  print("Check Key Button Pressed")
